...
def main():
    print_header()
    asin = asin_from_user()
    main_keyword = main_keyword_from_user()

    print()
    print("Scraping HTML from {}...".format(asin))
    ...
    print()
    print("Top review ratings:")
    print(top_review_ratings)

    recent_review_ratings = scrape_most_recent_review_ratings(html, asin)
    print()
    print("Most recent review ratings:")
    print(recent_review_ratings)

    image_count_actual = count_number_images(image_urls)
    # print()
    # print("Images used: {} out of 9.".format(image_count_actual))
    ...
    listing_score_details = calculate_listing_score(image_count_actual, keyword_in_title, overall_review_rating,
                                            ...
                                            bullet_length, using_coupon_feature, using_enhanced_brand_content,
                                            all_images_1000)


def print_header():
    print("------------------------------")
    print("        LISTING ANALYZER")
    print("------------------------------")


def asin_from_user():
    print("What ASIN do you want to analyze?")
    asin = input(">> ")
    # print("Do you want to analyze this ASIN: B01GIKGUAY?")
    # response = input(">> ")
    # asin = 'B01GIKGUAY'
    # asin = 'B06W5GJ6GN'
...
def main_keyword_from_user():
    print("What is your product's main keyword you want it to rank for?")
    main_keyword = input(">> ")
